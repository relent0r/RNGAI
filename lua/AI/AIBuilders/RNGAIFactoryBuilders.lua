...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'FactoryCapCheck', { 'LocationType', 'Land' } },
            { UCBC, 'PlayerRoleCheck', {'LocationType', 2, categories.FACTORY * categories.LAND, {'AIR', 'NAVAL'} }},
            { EBC, 'GreaterThanEconIncomeCombinedRNG',  { 0.0, 5.5 }},
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'FactoryCapCheck', { 'LocationType', 'Land' } },
            { UCBC, 'PlayerRoleCheck', {'LocationType', 2, categories.FACTORY * categories.LAND, {'AIR'} }},
            --{ EBC, 'GreaterThanMassToFactoryRatioBaseCheckRNG', { 'LocationType' } },
            { EBC, 'ZoneBasedFactoryToMassSupported', { 'LocationType', 'Land' } },
