...
BuilderGroup {
    ...
    Builder {
        ...
        DelayEqualBuildPlattons = {'HighValue', 20},
        BuilderConditions = {
            { EBC, 'HighValueGateRNG', {'debug'}},
            { UCBC, 'BuildOnlyOnLocationRNG', { 'LocationType', 'MAIN', 'debug' } },
            { UCBC, 'ValidateLateGameBuild', { 'LocationType', 'debug' }},
            { EBC, 'GreaterThanEconEfficiencyCombinedRNG', { 1.05, 1.1, 'debug' }},
            { EBC, 'GreaterThanEconIncomeCombinedRNG', { 8.0, 700.0, 'debug' }},
            { UCBC, 'IsEngineerNotBuilding', { categories.STRUCTURE * categories.ARTILLERY * categories.TECH3, 'debug' } },
            { TBC, 'EnemyThreatInT3ArtilleryRangeRNG', {'LocationType', 0.30, 'debug'} },
            { UCBC, 'HaveLessThanUnitsWithCategory', { 1, categories.STRUCTURE * categories.ARTILLERY * categories.TECH3, 'debug' }},
        },
        BuilderType = 'Any',
        BuilderData = {
            StateMachine = 'EngineerBuilder',
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'BuildOnlyOnLocationRNG', { 'LocationType', 'MAIN' } },
            { UCBC, 'ValidateLateGameBuild', { 'LocationType' }},
            { UCBC, 'T4StrategicArtilleryRequirementRNG', {'LocationType'}},
