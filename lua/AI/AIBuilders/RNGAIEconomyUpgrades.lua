...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveLessThanUnitsInCategoryBeingUpgraded', { 1, 'MASSEXTRACTION TECH2', 'MASSEXTRACTION' } },
        },
        FormRadius = 10000,
        BuilderType = 'Any',
    },
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveLessThanUnitsInCategoryBeingUpgraded', { 1, 'MASSEXTRACTION TECH1', 'MASSEXTRACTION TECH2', 'MASSEXTRACTION' } },
        },
        FormRadius = 60,
        BuilderType = 'Any',
    },
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { UCBC, 'HaveLessThanUnitsInCategoryBeingUpgraded', { 1, 'MASSEXTRACTION TECH3', 'MASSEXTRACTION' } },
        },
        FormRadius = 10000,
        BuilderType = 'Any',
    },
    Builder {
        ...
        BuilderConditions = {
            { IBC, 'BrainNotLowPowerMode', {} },
            { EBC, 'GreaterThanEconIncome',  { 1.8, 30}},
