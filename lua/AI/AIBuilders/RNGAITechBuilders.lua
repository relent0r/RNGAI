...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'CheckBuildPlatoonDelayRNG', { 'Factories' }},
            { EBC, 'GreaterThanEconStorageRatioRNG', { 0.15, 0.30}}, -- Ratio from 0 to 1. (1=100%)
    ...
    Builder {
        ...
        BuilderData = {
            Assist = {
                ...
                AssisteeType = categories.STRUCTURE,
                AssistRange = 100,
                BeingBuiltCategories = {categories.STRUCTURE * categories.FACTORY * categories.AIR - (categories.TECH2 + categories.TECH3 - categories.SUPPORTFACTORY)},
                AssistClosestUnit = true,
            },
        },
        BuilderType = 'Any',
...
BuilderGroup {
    ...
    Builder {
        ...
        InstanceCount = 1,
        BuilderConditions = {
                { UCBC, 'UnitsGreaterAtLocation', { 'LocationType', 1, (categories.TECH2 + categories.TECH3 ) * categories.SUPPORTFACTORY}},
                ...
                { UCBC, 'UnitsGreaterAtLocation', { 'LocationType', 5, categories.LAND * categories.FACTORY }},
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'UnitsGreaterAtLocation', { 'LocationType', 0, (categories.TECH2 + categories.TECH3) * categories.LAND * categories.FACTORY - categories.SUPPORTFACTORY }},
                { UCBC, 'UnitsGreaterAtLocation', { 'LocationType', 5, categories.LAND * categories.FACTORY }},
                { EBC, 'LessThanEconEfficiency', { 1.0, 3.0 }},
            },
        BuilderData = {
            Location = 'LocationType',
            Reclaim = {categories.STRUCTURE * categories.TECH1 * categories.LAND * categories.FACTORY},
    ...
    Builder {
        ...
        InstanceCount = 4,
        BuilderConditions = {
                { UCBC, 'UnitsGreaterAtLocation', { 'LocationType', 1, categories.TECH3 * categories.LAND * categories.FACTORY * categories.SUPPORTFACTORY}},
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { EBC, 'LessThanEconEfficiency', { 3.0, 1.3 }},
            { EBC, 'GreaterThanEconEfficiencyRNG', { 0.9, 0.1 }},
            { EBC, 'LessThanEconStorageRatio', { 2.0, 0.3}},
            { UCBC, 'HaveGreaterThanUnitsInCategoryBeingBuiltAtLocationRNG', { 'LocationType', 0, categories.STRUCTURE * categories.ENERGYPRODUCTION }},
            },
        BuilderData = {
            Assist = {
