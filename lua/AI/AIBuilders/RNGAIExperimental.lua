...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyCombinedRNG', { 1.05, 1.1 }},
            { EBC, 'GreaterThanEconIncomeCombinedRNG', { 15.0, 550.0 }},
        },
        BuilderType = 'Any',
        BuilderData = {
            StateMachine = 'EngineerBuilder',
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconStorageRatioRNG', { 0.45, 0.95 } },
            { EBC, 'GreaterThanEconIncomeCombinedRNG', { 35.0, 550.0 }},
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyCombinedRNG', { 1.2, 1.3 }},
            { EBC, 'GreaterThanEconStorageRatioRNG', { 0.95, 0.95 } },
        },
        BuilderType = 'Any',
        BuilderData = {
            StateMachine = 'EngineerBuilder',
    ...
    Builder {
        ...
        BuilderData = {
            ...
            PrioritizedCategories = { 
                ...
                categories.MOBILE * categories.TECH3 * categories.ENGINEER,
                categories.MOBILE * categories.TECH3,
                categories.MOBILE * categories.TECH2 * (categories.NAVAL + categories.ENGINEER),
            },
        },
    },
}
