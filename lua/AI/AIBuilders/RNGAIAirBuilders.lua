...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'RNGAI T1 Air Transport Pressure Large',
        PlatoonTemplate = 'T1AirTransport',
        Priority = 890,
        BuilderConditions = {
            { MIBC, 'TransportPressureLevelRNG', {3} },
            { EBC, 'GreaterThanEconEfficiencyRNG', { 0.85, 1.0 }},
            { UCBC, 'HaveLessThanUnitsWithCategory', { 3, categories.TRANSPORTFOCUS * categories.TECH1 - categories.GROUNDATTACK } },
            { UCBC, 'HaveLessThanUnitsInCategoryBeingBuiltRNG', { 1, categories.TRANSPORTFOCUS - categories.GROUNDATTACK } },
            { UCBC, 'UnitCapCheckLess', { .85 } },
        },
        BuilderType = 'Air',
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyRNG', { 0.90, 1.0 }},
    ...
    Builder {
        BuilderName = 'RNGAI T2 Air Transport Pressure Large',
        PlatoonTemplate = 'T2AirTransport',
        Priority = 890,
        BuilderConditions = {
            { MIBC, 'TransportPressureLevelRNG', {3} },
...
BuilderGroup {
    ...
    Builder {
        BuilderName = 'RNGAI T1 Air Transport Pressure Small',
        PlatoonTemplate = 'T1AirTransport',
        Priority = 890,
        BuilderConditions = {
            { MIBC, 'TransportPressureLevelRNG', {3} },
    ...
    Builder {
        BuilderName = 'RNGAI T2 Air Transport Pressure Small',
        PlatoonTemplate = 'T2AirTransport',
        Priority = 890,
        BuilderConditions = {
            { MIBC, 'TransportPressureLevelRNG', {3} },
