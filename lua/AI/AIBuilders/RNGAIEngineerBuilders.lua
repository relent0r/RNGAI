...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
            { UCBC, 'EnemyUnitsLessAtRestrictedRNG', { 'LocationType', 1, 'LAND' }},
            { UCBC, 'LocationDefenseCheck', { 'LocationType', 2, categories.ANTIAIR, 'AntiSurfaceAirUnits' } },
            { MABC, 'CanBuildOnMassDistanceRNG', { 'LocationType', 0, 60, false, -1000, 0, 'AntiSurface', 1 }},
            { UCBC, 'EngineerCapCheck', { 'LocationType', 'Tech1' } },
            { UCBC, 'UnitCapCheckLess', { .85 } },
        },
        BuilderType = 'All',
    ...
    Builder {
        ...
        BuilderConditions = {
            { MIBC, 'ExpansionIsActive', {'LocationType'} },
...
BuilderGroup {
    ...
    Builder {
        ...
        InstanceCount = 4,
        BuilderConditions = {
                { UCBC, 'UnfinishedUnitsAtLocationRNG', { 'LocationType', categories.STRUCTURE * ( categories.TECH2 * categories.ARTILLERY + categories.DEFENSE + categories.FACTORY + categories.MASSEXTRACTION ) }},
        ...
        BuilderData = {
            ...
            Assist = {
                ...
                BeingBuiltCategories = categories.STRUCTURE * ( categories.TECH2 * categories.ARTILLERY + categories.DEFENSE + categories.FACTORY + categories.MASSEXTRACTION ),
            },
        },
        BuilderType = 'Any',
    },
