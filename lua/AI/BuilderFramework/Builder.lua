...
Builder = ClassSimple {
    ...
    GetFactoryBuilderType = function(self)
        if Builders[self.BuilderName].FactoryBuilderType then
            return Builders[self.BuilderName].FactoryBuilderType
        end
        return false
    end,
    ...
    GetPlatoonTemplate = function(self)
        ...
        ---@param self Builder
    ---@return string|false
    GetUnitCategory = function(self)
        if Builders[self.BuilderName].UnitCategory then
            return Builders[self.BuilderName].UnitCategory
        end
        return false
    end,
...
FactoryBuilder = Class(Builder) {
    ...
    Create = function(self,brain,data,locationType)
        ...
        if not data['PlatoonTemplate'] and not data['UnitCategory'] then
            error('*BUILDER ERROR: Invalid builder data missing: PlatoonTemplate or UnitCategory - BuilderName given: ' .. data.BuilderName)
            return false
        end
        return true
    end,
