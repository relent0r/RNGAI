...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'HaveLessThanUnitsInCategoryBeingUpgraded', { 1, categories.STRUCTURE * categories.FACTORY * categories.LAND * categories.TECH1 }},
                { EBC, 'GreaterThanEconStorageRatio', { 0.03, 0.3}},
                { EBC, 'GreaterThanEconTrend', { 0.0, 0.0 } },
            },
        BuilderType = 'Any',
    },
    ...
    Builder {
        BuilderName = 'RNGAI T2 Land Factory Upgrade Excess',
        PlatoonTemplate = 'T2LandFactoryUpgrade',
        Priority = 800,
        InstanceCount = 1,
        BuilderConditions = {
...
BuilderGroup {
    ...
    Builder {
        ...
        BuilderConditions = {
                ...
                { UCBC, 'HaveGreaterThanUnitsWithCategory', { 1, (categories.MASSEXTRACTION * (categories.TECH2 + categories.TECH3)) * (categories.FACTORY * categories.AIR)}},
